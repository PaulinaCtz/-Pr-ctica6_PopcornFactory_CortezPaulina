...
class Catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas(){
        ...
        peliculas.add(Pelicula("Bones", R.drawable.bones, R.drawable.bonesheader, "Forensic anthropologist Dr Temperance 'Bones' Brennan and FBI Agent Seeley Booth form an unlikely alliance to solve cases by examining the remains of victims.", arrayListOf<Cliente>()))
        peliculas.add(Pelicula("Dr House", R.drawable.drhouse, R.drawable.drwhoheader, "Dr House, a medical genius, and his team get together to solve puzzling cases of patients with bizarre illnesses. In the process, they often end up flouting the hospital's administrative rules.",arrayListOf<Cliente>()))
        peliculas.add(Pelicula("Dr Who", R.drawable.drwho, R.drawable.drwhoheader,"`Doctor Who' is a classic science-fiction programme with a cult following. The Doctor is called a `Time Lord', a time-travelling scientist from a far off planet, who travels through time and space in a shop known by the acronym TARDIS.", arrayListOf<Cliente>()))
        peliculas.add(Pelicula("Frieds", R.drawable.friends, R.drawable.friendsheader, "Follow the lives of six reckless adults living in Manhattan, as they indulge in adventures which make their lives both troublesome and happening.", arrayListOf<Cliente>()))
        peliculas.add(Pelicula("Men in Black", R.drawable.mib, R.drawable.mibheader, "Men in Black is a series of American science fiction action comedy films directed by Barry Sonnenfeld, and based on the Malibu / Marvel comic book series The Men in Black by Lowell Cunningham, which was itself based on the conspiracy theory.", arrayListOf<Cliente>()))
        peliculas.add(Pelicula("SmallVille", R.drawable.smallville, R.drawable.smallvilleheader, "An interpretation of the Superman story features young Clark Kent coming to grips with his emerging superpowers. He must hide his abilities from his friends, including Lana Lang, the girl of his dreams, and Lex Luthor, who will one day become Superman's nemesis.",arrayListOf<Cliente>()))
        peliculas.add(Pelicula("Suits", R.drawable.suits, R.drawable.suitsheader, "Mike Ross, a talented young college dropout, is hired as an associate by Harvey Specter, one of New York's best lawyers. They must handle cases while keeping Mike's qualifications a secret.", arrayListOf<Cliente>()))
        peliculas.add(Pelicula("1917", R.drawable.war, R.drawable.warheader, "Two soldiers, assigned the task of delivering a critical message to another battalion, risk their lives for the job in order to prevent them from stepping right into a deadly ambush.", arrayListOf<Cliente>()))
    }
    ...
    class PeliculaAdapter:  BaseAdapter {
        ...
        override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
            ...
            imagen.setOnClickListener(){
                ...
                intento.putExtra("numberSeats", (20-prod.seats.size))
